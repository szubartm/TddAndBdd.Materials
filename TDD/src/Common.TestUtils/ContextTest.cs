...
namespace Common.TestUtils
{
    ...
    public abstract class ContextTest<T> where T : class
    {
        ...
        /// <summary>
        /// Arranges the properties and context for object under test.
        /// </summary>
        protected abstract T Arrange();

        /// <summary>
        /// The object under test is called within this method.
        /// </summary>
        protected abstract void Act();

        /// <summary>
        /// Runs the action on object under test, returns an exception if thrown
        /// </summary>
